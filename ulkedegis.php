...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "ulke")) {
  $updateSQL = sprintf("UPDATE uyeler SET Ulke=%s, sehir=%s WHERE uyeID=%s",
                       GetSQLValueString(filter($_POST['ulke']), "text"),
                       GetSQLValueString(filter($_POST['sehir']), "text"),
                       GetSQLValueString(filter($_POST['uyeID']), "int"));
           ...
           <div class="row-fluid">
             <div class="span12">
               ...
               <ul class="breadcrumb">
                 ...
                 <li> <a href="admin/index.php"><?php echo $dil['anasayfa']; ?></a> <span class="divider">&nbsp;</span> </li>
             ...
             <div class="span12">
               <div class="widget">
                 ...
                 <div class="control-group">
                   ...
                   <form action="<?php echo $editFormAction; ?>"  method="POST"  name="ulke"  id="ulke">  
                              <label class="control-label"><?php echo $dil['kayit_ulke']; ?></label>
                              <div class="controls">
                              
                              
                             
 
 <select name="ulke"  value="<?php echo $row_uyebilgileri['Ulke']; ?>" id="country" onChange="print_state('state', this.selectedIndex);" selected="selected" >



</select><?php echo $row_uyebilgileri['Ulke']; ?>
                     
                                
                              </div>
                      
                                  <div class="control-group">
                              <label class="control-label"><?php echo $dil['kayit_sehir']; ?></label>
                              <div class="controls">
                              <select name ="sehir" id ="state"></select><?php echo $row_uyebilgileri['sehir']; ?>
                              </div>
                           </div>
                           
                               <input name="uyeID" type="hidden" class="span4 " id="uyeID" value="<?php echo $row_uyebilgileri['uyeID']; ?>">
    <input type="submit" class="btn btn-success" value="<?php echo $dil['duzenle']; ?>" id="submit">
    <input type="hidden" name="MM_update" value="ulke">
                   </form>  
...
<!-- InstanceBeginEditable name="degis" -->
   ...
   <script language="javascript">print_country("country", "USA", "Virginia");</script>
<script>
