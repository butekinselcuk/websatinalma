         ...
         <div class="container-fluid">
           ...
           <div class="row-fluid">
             <div class="span12">
               ...
               <h3 class="page-title"> Kayıt Sayfası </h3>
               <ul class="breadcrumb">
               </ul>
...
<div class="widget">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Finansal Bilgiler</h4>
                        ...
                        <div class="widget-body form">
                          ...
                          <form action="#" class="form-horizontal">
						<div class="control-group">
                              <label class="control-label">Geçen yıl ciro</label>
                              <div class="controls">
                                 <div class="input-prepend input-append">
                                    <span class="add-on">$</span><input class="span8 popovers" data-trigger="hover" data-content="Geçen yıl ciro."" type="text"><span class="add-on">.00</span>
                                 </div>
                              </div>
                         </div>
                              ...
                              <div class="controls">
                                 <div class="input-prepend input-append">
                                    <span class="add-on">$</span><input class="span8 popovers" data-trigger="hover" data-content="Ekipman yatırımı."" type="text"><span class="add-on">.00</span>
                                 </div>
                              </div>
                              <label class="control-label">İhracat Oranı</label>
                              <div class="controls">
                                 <div class="input-prepend input-append">
                                    <span class="add-on">%</span><input class="span3 popovers" data-trigger="hover" data-content="Yüzdelik olarak giriniz."" type="text">
                                 </div>
                              </div>   
...
<div class="widget">
                        <div class="widget-title">
                           <h4><i class="icon-globe"></i>Kontak Bilgileri</h4>
                        ...
                        <div class="widget-body">
                            ...
                            <thead>
                                <tr>
                                    <th width="140"></th>
                                    <th width="140" class="hidden-phone">Person/Title</th>
                                    <th width="140" class="hidden-phone">Tel</th>
                                    <th width="140" class="hidden-phone">E-mail</th>
                                </tr>
                            </thead>
                            <tbody>

                                <tr class="odd gradeX">
                                  <td width="140">Hesap Yönetici</td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                  <td width="140" class="center hidden-phone"><input class="span10" type="text"></td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                </tr>
                                <tr class="odd gradeX">
                                  <td width="140">Sales & Marketing</td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                  <td width="140" class="center hidden-phone"><input class="span10" type="text"></td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                </tr>
                                ...
                                <tr class="odd gradeX">
                                  <td width="140">Logistics</td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                  <td width="140" class="center hidden-phone"><input class="span10" type="text"></td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                </tr>
                                <tr class="odd gradeX">
                                  <td width="140">Purchasing</td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                  <td width="140" class="center hidden-phone"><input class="span10" type="text"></td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                </tr>
                                <tr class="odd gradeX">
                                  <td width="140">Quality</td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                  <td width="140" class="center hidden-phone"><input class="span10" type="text"></td>
                                    <td width="140" class="hidden-phone"><input class="span10" type="text"></td>
                                </tr>
