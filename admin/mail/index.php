...
$query_uyebilgileri = sprintf("SELECT * FROM uyeler WHERE uyeAdi = %s", GetSQLValueString($colname_uyebilgileri, "text"));
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               <!-- BEGIN LOGO -->
                   ...
                   <a class="nav top-men" href="../index.php">           
                   <img src="../resim/logo/<?php echo $row_ayar['Sitelogo']; ?>" alt="QHubi.com">
               </a>
               ...
               <!-- END RESPONSIVE MENU TOGGLER -->
                   ...
                   <ul class="nav pull-right top-menu">
                       ...
                       <li class="dropdown mtop5">
                           ...
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="../sohbet/index.php" data-original-title="Chat">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="../Hesap/index.php"><i class="icon-user"></i> <?php echo $dil['profilim']; ?></a></li>
                               <li class="divider"></li>
                               <li><a href="../cikis.php"><i class="icon-key"></i> <?php echo $dil['cikisyap']; ?></a></li>
                           </ul>
                       </li>
                  ...
                  <?php if($row_uyebilgileri['seviyeID']== 1)
{
  ?>
                  ...
                  <ul class="sub">
                      <li><a class="" href="../index.php">Ana Sayfa</a></li>
                      <li><a class="" href="../Ayar/index.php">Site Ayarları</a></li>
                      <li><a class="" href="../Ayar/uyeler/index.php">Üyeler</a></li>
                      <li><a class="" href="../Ayar/seviyeler/index.php">Üye Seviyeleri</a></li>
                      <li><a class="" href="../Kategoriler/index.php">Kategoriler</a></li>
              ...
              <li class="has-sub">
                  ...
                  <a href="javascript:;" class="active">
 					...
 					<ul class="sub">
                    	<li class="active"><a class="" href="../Hesap/index.php"><?php echo $dil['ayarlar']; ?></a></li>
                        <li class="active"><a class="" href="../../sifredegis.php"><?php echo $dil['sifre_degis']; ?></a></li>
                        <li class="active"><a class="" href="../Hesap/yukle/index.php"><?php echo $dil['sirketresim']; ?></a></li>
                        <li class="active"><a class="" href="../Hesap/yukle/index1.php"><?php echo $dil['sertifikaresim']; ?></a></li>
                    </ul>
              </li>

              <li class="has-sub">
                  <a href="../Teklif/verme/index.php" class="">
              ...
              <li class="has-sub">
                  <a href="../Teklif/alma/index.php" class="">
              ...
              <li class="has-sub">
                  <a href="../Firmalar/index.php" class="">
                      <span class="icon-box"><i class="icon-globe"></i></span> <?php echo $dil['firmalar']; ?>
                      </span>
                  </a>
              </li>
              <li class="has-sub">
                  <a href="../Teklif/tekliflerim/index.php" class="">
         ...
         <div class="container-fluid">
           ...
           <div class="row-fluid">
             <div class="span12">
               ...
               <h3 class="page-title"><?php echo $dil['yhosgeldiniz']; ?>  </h3>
               <ul class="breadcrumb">
                 <li> <a href="../index.php"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                 <li> <a href="../../index.php"><?php echo $dil['anasayfa']; ?></a> <span class="divider-last">&nbsp;</span> </li>
               </ul>
             ...
             <div class="span12">
               <div class="widget">
                 <div class="widget-title">
                   <h4><i class="icon-globe"></i>Mail </h4>
                 </div>
                 <div class="widget-body">
                   <p>Mail Gönderildi/Mail Sent/发送邮件</p>
                   <p></p>
                 </div>
               </div>
             </div>
...
<!-- InstanceBeginEditable name="degis" -->
   ...
   <script src="../assets/jquery-slimscroll/jquery-ui-1.9.2.custom.js"></script>
  ...
  ga('send', 'pageview');
   ...
   <script type="text/javascript" src="../assets/data-tables/jquery.js"></script>
   <script type="text/javascript" src="../assets/data-tables/DT_bootstrap.js"></script>
   <script src="../assets/jquery-ui/jquery-ui-1.10.1.custom.js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/jquery.js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/maps/jquery.vmap.js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/maps/jquery.vmap (1).js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/maps/jquery.vmap (2).js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/maps/jquery.vmap (3).js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/maps/jquery.vmap (4).js" type="text/javascript"></script>
   <script src="../assets/jqvmap/jqvmap/data/jquery.vmap.js" type="text/javascript"></script>
   <script src="../assets/jquery-knob/js/jquery.js"></script>
   <script src="../assets/flot/jquery.js"></script>
   <script src="../assets/flot/jquery.flot.js"></script>
   <script src="../assets/flot/jquery.flot (1).js"></script>
   <script src="../assets/flot/jquery.flot (2).js"></script>
   <script src="../assets/flot/jquery.flot (3).js"></script>
