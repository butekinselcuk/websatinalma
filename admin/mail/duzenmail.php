...
<thead>
      <tr height='80'>
       <th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;' >".$TalepID     = filter($_POST['TalepID'])." Nolu Teklif Talebi güncellendi!</th>
      </tr>
      </thead>
...
Açiklama: ".$aciklama=$_POST['aciklama']." <br/>
...
$mail->Subject  =  " $TalepID Nolu Teklif Talebi güncellendi!";
