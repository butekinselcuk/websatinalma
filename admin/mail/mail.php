...
$message  = "<html><body>";
   ...
   $message .= "<thead>
      <tr height='80'>
       <th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;' >Yeni Teklif Talebi</th>
      </tr>
      </thead>";
...
Ödeme Kosul:  ".$odeme=$_POST['odemekosul']." <br/>
Ödeme Vadesi: ".$vade=$_POST['odemevadesi']." <br/> 
Teslim Sekli : ".$teslimsekli=$_POST['teslimsekli']." <br/>
Teslim Süresi: ".$tsure=$_POST['teslimsure']." <br/>
Hedef Fiyat:".$hedef=$_POST['hedeffiyat']." <br/>
Parabirimi:".$parabirimi=$_POST['parabirim']." <br/>
Forecast:".$forecast=$_POST['forecast']." <br/>
Açıklama: ".$aciklama=$_POST['aciklama']." <br/>
Adres:".$adres=$_POST['adres']." <br/>
...
$mail->CharSet = 'UTF-8';
$mail->isHTML(true);
$mail->From     = "info@qhubi.com"; // smtp kullan�c� ad�n�z ile ayn� olmal�
$mail->Fromname = "giden ismi";
$mail->Subject  =  "Yeni Teklif Talebi Mevcut";
