...
$stmt = $pdo->prepare("UPDATE destek SET durum = :durum WHERE destekID = :destekID");

// Bind the parameters
$stmt->bindParam(':durum', $newDurum, PDO::PARAM_INT);
$stmt->bindParam(':destekID', $s, PDO::PARAM_INT);
