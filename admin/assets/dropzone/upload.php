...
if (isset($_GET['pageNum_teklifoku'])) {
  $pageNum_teklifoku = $_GET['pageNum_teklifoku'];
}
...
if (isset($_GET['totalRows_teklifoku'])) {
  $totalRows_teklifoku = $_GET['totalRows_teklifoku'];
} else {
...
<head>
   ...
   <link href="../fancybox/source/jquery.css" rel="stylesheet">
   <link rel="stylesheet" type="text/css" href="../gritter/css/jquery.css">
   <link rel="stylesheet" type="text/css" href="../uniform/css/uniform.css">
   <link rel="stylesheet" type="text/css" href="../chosen-bootstrap/chosen/chosen.css">
   <link rel="stylesheet" type="text/css" href="../jquery-tags-input/jquery.css">    
   <link rel="stylesheet" type="text/css" href="../clockface/css/clockface.css">
   <link rel="stylesheet" type="text/css" href="../bootstrap-wysihtml5/bootstrap-wysihtml5.css">
   <link rel="stylesheet" type="text/css" href="../bootstrap-datepicker/css/datepicker.css">
   <link rel="stylesheet" type="text/css" href="../bootstrap-timepicker/compiled/timepicker.css">
   <link rel="stylesheet" type="text/css" href="../bootstrap-colorpicker/css/colorpicker.css">
   <link rel="stylesheet" href="../bootstrap-toggle-buttons/static/stylesheets/bootstrap-toggle-buttons.css">
           ...
           <div class="row-fluid">
             <div class="span12">
               ...
               <ul class="breadcrumb">
                 ...
                 <li> <a href="../../index.php">Yönetim Ana Sayfa</a> <span class="divider">&nbsp;</span> </li>
...
$uploadDir = "uploads/";
$uploadFile = $uploadDir . basename($_FILES[$row_uyebilgileri['UyeAdi']]["name"]);
...
<body class="fixed-top">
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="../../index.php">
                   <img src="../../img/logo.png" alt="QHubi.com">
               </a>
               <!-- END LOGO -->
               ...
               <div id="top_menu" class="nav notify-row">
                   ...
                   <ul class="nav top-menu">
                       <!-- BEGIN SETTINGS -->
                       <li class="dropdown">
                           <a class="dropdown-toggle element" data-placement="bottom" data-toggle="tooltip" href="../../Ayar/index.php" data-original-title="Site Ayarları">
                               <i class="icon-cog"></i>
                           </a>
                       </li>
                       <!-- END SETTINGS -->
                         ...
                         <?php if($row_teklifoku['teklifaktif']=='0') :?>
                           ...
                           <ul class="dropdown-menu extended inbox">
                               <li>
                                  ...
                                  <li>
                                  <?php do { ?>
                                    <a href="../../Teklif/tekliflerim/index.php">
                   ...
                   <ul class="nav pull-right top-menu">
                       ...
                       <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                               <li><a href="../../Ayar/uyeler/duzenle.php?uyeID=<?php echo $row_uyebilgileri['uyeID']; ?>"><i class="icon-user"></i> Profilim</a></li>
                               <li class="divider"></li>
                               <li><a href="../../cikis.php"><i class="icon-key"></i> Çıkış Yap</a></li>
                           </ul>
                       </li>
      ...
      <div id="sidebar" class="nav-collapse collapse">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="has-sub">
                  <a href="../../Kategoriler/index.php" class="">
               ...
               <div class="span12">
                  ...
                  <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="../../index.php">Yönetim Ana Sayfa</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="#">Blank Page</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   <!-- END PAGE TITLE & BREADCRUMB-->
   ...
   <![endif]-->
   <script type="text/javascript" src="../chosen-bootstrap/chosen/chosen.jquery.js"></script>
   <script type="text/javascript" src="../uniform/jquery.uniform.js"></script>
   <script type="text/javascript" src="../bootstrap-wysihtml5/wysihtml5-0.3.js"></script> 
   <script type="text/javascript" src="../bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
   <script type="text/javascript" src="../clockface/js/clockface.js"></script>
   <script type="text/javascript" src="../jquery-tags-input/jquery.tagsinput.js"></script>
   <script type="text/javascript" src="../bootstrap-toggle-buttons/static/js/jquery.toggle.js"></script>
   <script type="text/javascript" src="../bootstrap-datepicker/js/bootstrap-datepicker.js"></script>   
   <script type="text/javascript" src="../bootstrap-daterangepicker/date.js"></script>
   ...
   <script type="text/javascript" src="../bootstrap-inputmask/bootstrap-inputmask.js"></script>
   <script type="text/javascript" src="../data-tables/jquery.js"></script>
